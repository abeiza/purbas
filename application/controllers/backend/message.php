<?php 
	...
	class Message extends CI_Controller{
		...
		function delete($id){
			...
			$delete = $this->model_purb->get_delete('purb_message','message_id',$id);
			...
			if(!$delete){
				...
				Header("Location:".base_url()."index.php/backend/message/");
			}else{
...
/*Location:.application/controller/backend/message.php*/