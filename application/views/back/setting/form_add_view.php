                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Form Update <small>(Form Update Information)</small></h2>
                                ...
                                <div class="x_content">
									...
									<?php 
										...
										echo form_open_multipart('backend/setting/update_act/', $attributes);
									?>
                                        ...
                                        <span class="section">Website Identity</span>

                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Brand Logo
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="file" id="logo" name="logo" class="form-control col-md-7 col-xs-12" placeholder="Picture">
                                            </div>
                                        </div>
										...
										<div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" class="form-control col-md-7 col-xs-12" name="name" placeholder="Website Name" required="required" value="<?php echo $name;?>" type="text">
                                            </div>
                                        </div>
										<div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Brand Tagline
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="tag" class="form-control col-md-7 col-xs-12" name="tag" placeholder="Tagline" value="<?php echo $tag;?>" type="text">
                                            </div>
                                        </div>
										<div class="item form-group">
