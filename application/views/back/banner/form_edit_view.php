                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Form Edit <small>(Form edit data banner)</small></h2>
                                ...
                                <div class="x_content">
									...
									<?php 
										...
										echo form_open_multipart('backend/banner/edit/'.$id, $attributes);
									?>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12">
                                                <input id="title" value="<?php echo $title;?>" class="form-control col-md-7 col-xs-12" name="title" placeholder="Title Banner" required="required" type="text">
                                            </div>
                                        </div>
										<div class="item form-group">
										...
										<div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="old">Old Url
                                            </label>
                                            <div class="col-md-9 col-sm-12 col-xs-12">
                                                <input id="old" value="<?php echo $url;?>" readonly class="form-control col-md-7 col-xs-12" name="old" placeholder="Link Url" required="required" type="text">
                                            </div>
                                        </div>
										<div class="item form-group">
										...
										<div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12">
                                                <textarea style="height:150px;" id="desc" class="form-control col-md-7 col-xs-12" name="desc" placeholder="Desc. Banner . . ."><?php echo $desc;?></textarea>
                                            </div>
                                        </div>
