                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
									...
									<?php 
										...
										echo form_open('backend/manage_category/edit/'.$id, $attributes);
									?>
										...
										<div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea id="desc" style="height:200px;" class="form-control col-md-7 col-xs-12" name="desc" placeholder="Description"><?php echo $desc;?></textarea>
                                            </div>
                                        </div>
