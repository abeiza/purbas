                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Form Add <small>(Form add new data post)</small></h2>
                                ...
                                <div class="x_content">
									...
									<?php 
										...
										echo form_open_multipart('backend/manage_post/add/', $attributes);
									?>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12">
                                                <input id="title" class="form-control col-md-7 col-xs-12" name="title" placeholder="Title Post" required="required" type="text">
                                            </div>
                                        </div>
										<div class="item form-group">
                                            ...
                                            <div class="col-md-9 col-sm-12 col-xs-12">
                                                <textarea style="height:150px;" required="required" id="short" class="form-control col-md-7 col-xs-12" name="short" placeholder="Short Description"></textarea>
                                            </div>
                                        </div>
										<div class="item form-group">
                                                ...
                                                <select id="category" class="form-control col-md-7 col-xs-12" name="category">
													...
													<?php 
														foreach($category->result() as $db){
															echo "<option value='".$db->category_post_id."'>".$db->category_post_name."</option>";
														}
													?>
												</select>
                                            </div>
