                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Form Add <small>(Form add new data category)</small></h2>
                                ...
                                <div class="x_content">
									...
									<?php 
										...
										echo form_open('backend/manage_category/add/', $attributes);
									?>
										...
										<div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea style="height:200px;" id="desc" class="form-control col-md-7 col-xs-12" name="desc" placeholder="Description" type="text"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-3">
                                                <a href="<?php echo base_url().'index.php/backend/manage_category/';?>"><button type="button" class="btn btn-primary">Cancel</button></a>
