                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>All Data Pages <small>(List Data Pages)</small></h2>
                                    <div class="input-group" style="float:right;">
										<a href="<?php echo base_url().'index.php/backend/manage_page/form_add/';?>"><button type="button" class="btn btn-primary">Add Page</button></a>
									</div>
									<div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                        ...
                                        <tbody>
											<?php 
												if($pages->num_rows() == 0){
													...
													foreach($pages->result() as $db){
														echo '<tr class="even pointer">';
														echo '<td class=" "></td>';
														echo '<td class=" ">'.$db->page_title.'</td>';
														echo '<td class=" ">'.$db->author.'</td>';
														if(empty($db->page_date_update)){
															echo '<td class=" ">'.$db->page_date_create.'</td>';
														}else{
															echo '<td class=" ">'.$db->page_date_update.'</td>';
														}
														echo '<td class=" last"><a style="margin:0px 5px;" href="'.base_url().'index.php/backend/manage_page/form_edit/'.$db->page_id.'">Edit</a><a style="margin:0px 5px;" href="'.base_url().'index.php/backend/manage_page/delete/'.$db->page_id.'">Delete</a>';
														echo '</tr>';
													}
												}
