                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Form Add <small>(Form add new data page)</small></h2>
                                ...
                                <div class="x_content">
									...
									<?php 
										...
										echo form_open_multipart('backend/manage_page/add/', $attributes);
									?>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12">
                                                <input id="title" class="form-control col-md-7 col-xs-12" name="title" placeholder="Title Page" required="required" type="text">
                                            </div>
                                        </div>
										<div class="item form-group">
