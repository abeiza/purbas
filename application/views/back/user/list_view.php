                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>All Data Users <small>(List Data Users)</small></h2>
                                    <div class="input-group" style="float:right;">
										<a href="<?php echo base_url().'index.php/backend/manage_user/form_add/';?>"><button type="button" class="btn btn-primary">Add User</button></a>
									</div>
									<div class="clearfix"></div>
                                </div>
                                <div class="x_content">
											...
											<?php 
												if($user->num_rows() == 0){
													...
													foreach($user->result() as $db){
														...
														echo '<td class=" "></td>';
														echo '<td class=" ">'.$db->user_first_name.' '.$db->user_last_name.'</td>';
														echo '<td class=" ">'.$db->user_nick.'</td>';
														echo '<td class=" ">'.$db->user_username.'</td>';
														echo '<td class=" ">'.$db->user_email.'</td>';
														echo '<td class=" last"><a style="margin:0px 5px;" href="'.base_url().'index.php/backend/manage_user/form_edit/'.$db->user_id.'">Edit</a><a style="margin:0px 5px;" href="'.base_url().'index.php/backend/manage_user/delete/'.$db->user_id.'">Delete</a>';
														echo '</tr>';
													}
												}
