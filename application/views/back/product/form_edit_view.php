                ...
                <div class="">
                    ...
                    <div class="row">
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="x_panel">
                                <div class="x_title">
                                    <h2>Picture <small>(Photo Product)</small></h2>
                                ...
                                <div class="x_content">
									...
									<?php }else{?>
										<div style="width:100%;background-color:#f1f1f1;text-align:center;">
											<img src="<?php echo base_url().'uploads/product/original/'.$pict;?>" style="width:100%;"/>
										</div>
									<?php }?>
								</div>
							</div>
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Form Edit <small>(Form edit data product)</small></h2>
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                        </li>
                                        <li class="dropdown">
                                ...
                                <div class="x_content">
									...
									<?php 
										...
										echo form_open_multipart('backend/manage_product/edit/'.$id, $attributes);
									?>
                                     ...
                                     <div class="item form-group">
										...
										<div class="col-md-6 col-sm-12 col-xs-12">
											<input value="<?php echo $name;?>" id="name" class="form-control col-md-7 col-xs-12" name="name" placeholder="Product Name" required="required" type="text">
										</div>
									</div>
									<div class="item form-group">
										...
										<div class="col-md-5 col-sm-12 col-xs-12">
											<input value="<?php echo $code;?>" id="code" class="form-control col-md-7 col-xs-12" name="code" placeholder="Code Principle" required="required" type="text">
										</div>
									</div>
									<div class="item form-group">
											...
											<select id="category" class="form-control col-md-7 col-xs-12" name="category">
												...
												<?php 
													foreach($category->result() as $db){
														echo "<option value='".$db->category_id."'";
														if($cat == $db->category_id){
															echo "selected";
														}
														echo ">".$db->category_name."</option>";
													}
												?>
											</select>
										</div>
