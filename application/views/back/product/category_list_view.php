											...
											<?php 
												if($category->num_rows() == 0){
													...
													foreach($category->result() as $db){
														...
														echo '<td class=" "></td>';
														echo '<td class=" ">'.$db->category_name.'</td>';
														echo '<td class=" ">'.$db->category_desc.'</td>';
														echo '<td class=" ">'.$db->category_date_update.'</td>';
														echo '<td class=" last"><a style="margin:0px 5px;" href="'.base_url().'index.php/backend/manage_category_page/form_edit/'.$db->category_id.'">Edit</a><a style="margin:0px 5px;" href="'.base_url().'index.php/backend/manage_category_page/delete/'.$db->category_id.'">Delete</a>';
														echo '</tr>';
													}
												}
