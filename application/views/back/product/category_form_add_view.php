                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
									...
									<?php 
										...
										echo form_open('backend/manage_category_page/add/', $attributes);
									?>
										...
										<div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea style="height:200px" id="desc" class="form-control col-md-7 col-xs-12" name="desc" placeholder="Description"></textarea>
                                            </div>
                                        </div>
