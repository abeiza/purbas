                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>SubMenu <?php echo $id;?><small>(List Data SubMenu Detail Link)</small></h2>
                                    <div class="input-group" style="float:right;">
										<a href="<?php echo base_url().'index.php/backend/menu/submenu_detail_form_add/'.$kode.'/'.$id;?>"><button type="button" class="btn btn-primary">Add SubMenu Detail</button></a>
									</div>
									<div class="input-group" style="float:right;">
										<a href="<?php echo base_url().'index.php/backend/menu/submenu/'.$kode;?>"><button type="button" class="btn btn-primary">Back</button></a>
									</div>
									<div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        <thead>
                                            <tr class="headings">
												...
												<th style="text-align:center;vertical-align:inherit">URL Link </th>
											...
											<?php 
												if($sub_menu->num_rows() == 0){
													...
													foreach($sub_menu->result() as $db){
														...
														echo '<td class=" "></td>';
														echo '<td class=" ">'.$db->menu_detail_label.'</td>';
														echo '<td class=" ">'.$db->menu_detail_url.'</td>';
														
														echo '<td class=" last"><a style="margin:0px 5px;" href="'.base_url().'index.php/backend/menu/submenu_detail_form_edit/'.$kode.'/'.$id.'/'.$db->menu_detail_id.'">Edit</a><a style="margin:0px 5px;" href="'.base_url().'index.php/backend/menu/submenu_detail_delete/'.$kode.'/'.$id.'/'.$db->menu_detail_id.'">Delete</a>';
														echo '</tr>';
													}
												}
