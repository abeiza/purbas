                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Form Add <small>(Form add new detail)</small></h2>
                                ...
                                <div class="x_content">
									...
									<?php 
										...
										echo form_open('backend/menu/submenu_detail_add/'.$kode.'/'.$id, $attributes);
									?>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-3">
                                                <a href="<?php echo base_url().'index.php/backend/menu/submenu_detail/'.$kode.'/'.$id;?>"><button type="button" class="btn btn-primary">Cancel</button></a>
