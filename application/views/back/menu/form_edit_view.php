                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Form Edit <small>(Form edit data menu)</small></h2>
                                ...
                                <div class="x_content">
									...
									<?php 
										...
										echo form_open('backend/menu/edit/'.$menu_id, $attributes);
									?>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" value="<?php echo $menu_name;?>" class="form-control col-md-7 col-xs-12" name="name" placeholder="Menu Label" required="required" type="text">
                                            </div>
                                        </div>
										<div class="item form-group">
										...
										<div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="url_link" value="<?php echo $menu_url;?>" class="form-control col-md-7 col-xs-12" name="url_link" placeholder="URL Link" required="required" type="text">
                                            </div>
                                        </div>
										<div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea style="height:100px"id="remark" class="form-control col-md-7 col-xs-12" name="remark" placeholder="Remark" ><?php echo $menu_remark;?></textarea>
                                            </div>
                                        </div>
