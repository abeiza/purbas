                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Form Edit <small>(Form edit data detail)</small></h2>
                                ...
                                <div class="x_content">
									...
									<?php 
										...
										echo form_open('backend/menu/submenu_detail_edit/'.$kode.'/'.$id2.'/'.$id, $attributes);
									?>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Detail SubMenu (Label) <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" value="<?php echo $menu_detail_label;?>" class="form-control col-md-7 col-xs-12" name="name" placeholder="Menu Label" required="required" type="text">
                                            </div>
                                        </div>
										<div class="item form-group">
										...
										<div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="url_link" value="<?php echo $menu_detail_url;?>" class="form-control col-md-7 col-xs-12" name="url_link" placeholder="URL Link" required="required" type="text">
                                            </div>
                                        </div>
										
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-3">
                                                <a href="<?php echo base_url().'index.php/backend/menu/submenu_detail/'.$kode.'/'.$id2;?>"><button type="button" class="btn btn-primary">Cancel</button></a>
