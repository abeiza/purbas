				...
				<div class="span8">
					<?php echo form_open();?>
						...
						<div class="row" style="margin-left:0px;font-size:13px;">
							...
							<textarea class="form_control" style="width:83%;float:left;margin:10px;height:100px;"></textarea>
						</div>
						<div><button style="margin-left:10px;"><i class="fa fa-send" style="margin:10px auto;margin-right:10px;"></i>Send</button></div>
					<?php echo form_close();?>
				</div>
				<div class="span4">
					...
					<div class="contact"  style="padding:20px ;width:90%;font-size:13px;">
						<table>
							...
							<tr>
								<td style="font-weight:bold;width:50%">Phone</td>
								<td><?php echo $phone1;?> , <?php echo $phone1;?></td>
							</tr>
							<tr>
								<td style="font-weight:bold;width:50%">Fax</td>
								<td><?php echo $fax;?></td>
							</tr>
							<tr>
							...
							<td style="font-weight:bold;width:50%">Company Website</td>
								<td>www.goc.co.id</td>
						</table>
					</div>
				</div>
