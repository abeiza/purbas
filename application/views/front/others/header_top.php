      ...
      <div class="wrapper_w">
		...
		<div class="pull-right">
          <div style="padding:10px 0px;">
			...
			<a style="text-decoration:none;color:#fff;" href="<?php echo $linkedin;?>"><span class="fa fa-linkedin" style="color:#fff;background-color:transparent;padding:0px 6px;font-size:18px;margin-right:5px;border-radius:100px;"></span>
		  </div>
        </div>
      </div>
    </div>
